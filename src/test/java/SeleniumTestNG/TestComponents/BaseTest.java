package SeleniumTestNG.TestComponents;
...

{
	...
	public WebDriver initilizeDriver() throws IOException
	{
		...
		FileInputStream fis=new FileInputStream(System.getProperty("user.dir") +"\\src\\main\\java\\AshviniPakhare\\resources\\GlobatData.properties");
		prop.load(fis);
	...
	public List<HashMap<String,String>> getJsonDataToMap(String filepath) throws IOException
	{
		...
		//read string to hashmap jackson databind
